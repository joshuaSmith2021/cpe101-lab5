...
import unittest
from map import cube_all, add_n_to_all, div_by_5_all
...
class TestPoly(unittest.TestCase):
    ...
    def test_add_n_to_all(self):
        ...
        self.assertListEqual(add_n_to_all([0, 1, 2, 3, 4, 5], 10),
                             [10, 11, 12, 13, 14, 15])

        self.assertListEqual(add_n_to_all([-14, 14, 3, 13], -5),
                             [-19, 9, -2, 8])
    ...
    def test_div_by_5_all(self):
        ...
        self.assertListEqual(div_by_5_all([51, 24, 25, -125, 0]),
                             [False] * 2 + [True] * 3)
